...
@Component({
  selector: 'ngx-room-selector3',
  templateUrl: './room-selector3.component.html',
  styleUrls: ['./room-selector3.component.scss'],
})
export class RoomSelector3Component {
  ...
  roomSvg = {
    ...
    rooms: [
      {
        id: '0',
        name: { text: 'Twin Room', x: 142, y: 240.8 },
      ...
      {
        id: '1',
        name: { text: 'Nano Room', x: 109, y: 66 },
      ...
      {
        id: '2',
        name: { text: 'Deluxe Room', x: 468, y: 134 },
      ...
      {
        id: '3',
        name: { text: 'Lobby Hotel', x: 320, y: 273 },
