...
@Component({
  selector: 'ngx-link-detail-room-information',
  templateUrl: './link-detail-room-information.component.html',
  styleUrls: ['./link-detail-room-information.component.scss'],
})
export class LinkDetailRoomInformationComponent implements OnInit, OnDestroy {
  renderId: any;
  renderNumber: any;
