...
@Component({
  selector: 'ngx-add-stay',
  templateUrl: './add-stay.component.html',
  styleUrls: ['./add-stay.component.scss'],
})
export class AddStayComponent implements OnInit, OnDestroy {
