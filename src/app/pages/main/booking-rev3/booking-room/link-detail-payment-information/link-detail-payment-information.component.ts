...
@Component({
  selector: 'ngx-link-detail-payment-information',
  templateUrl: './link-detail-payment-information.component.html',
  styleUrls: ['./link-detail-payment-information.component.scss'],
})
export class LinkDetailPaymentInformationComponent implements OnInit, OnDestroy {
  renderValue: any;
